...
export const TrademarkForm = () => {
  ...
  const handleRemoveKeyword = (keywordToRemove: string) => {
    // Remove the keyword from localStorage
    const removed = removeCustomKeyword(keywordToRemove);
    ...
    if (removed) {
      ...
      // If it's a predefined keyword, we don't want to allow removing it
      ...
      if (!predefinedKeywords.includes(keywordToRemove)) {
        toast.error("Failed to remove keyword");
      } else {
        toast.info("Predefined keywords cannot be removed");
      }
    }
  };
